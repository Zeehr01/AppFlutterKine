...
class ExoEtirement extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ExoEtirement();
  }
}

class _ExoEtirement extends State<ExoEtirement> {
  Stream etirementStream;
  ...
  @override
  void initState() {
    datamethods.getexercicesEtirement().then((value) {
      etirementStream = value;
      setState(() {});
    });
    super.initState();
  }
