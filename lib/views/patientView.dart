...
class PatientViewList extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _PatientViewList();
  }
}

class _PatientViewList extends State<PatientViewList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarMainKineMesPatient(context),
      body: patientList(),
    );
  }
}
