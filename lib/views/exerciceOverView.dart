...
class ExerciceOverView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ExerciceOverView();
  }
}

class _ExerciceOverView extends State<ExerciceOverView> {
  Stream exerciceStream;
  ...
  @override
  void initState() {
    datamethods.getexercices().then((value) {
      exerciceStream = value;
      setState(() {});
    });
    super.initState();
  }
